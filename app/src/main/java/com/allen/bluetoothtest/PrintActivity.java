    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.printactivity_print:
                if(!address.equals("")){
                    if(et_qrcode.getText().equals("")||et_ItemNo.getText().equals("")||et_goods.getText().equals("")||et_specifications.getText().equals("")||et_barcode.getText().equals("")){
                        tscPrint.printData(address,"13640B J1338-864-20","打印品号","打印品名","打印规格","打印条码");
                    }else {
                        tscPrint.printData(address,et_qrcode.getText().toString(),et_ItemNo.getText().toString(),et_goods.getText().toString(),et_specifications.getText().toString(),et_barcode.getText().toString());
                    }
                }else{
